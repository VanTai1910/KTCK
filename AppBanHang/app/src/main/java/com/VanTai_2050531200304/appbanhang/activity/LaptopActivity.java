...
import com.VanTai_2050531200304.appbanhang.adapter.LaptopBaseAdapter;
...
public class LaptopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CheckConnection.haveNetworkConnection(getApplicationContext())){
            ...
            CheckConnection.ShowToast_Short(getApplicationContext(),"Mời bạn vui lòng kiểm lại kết nối");
        }
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    ...
                    limitdataLap = true;
                    lvlaptop.removeFooterView(footerViewLT);
                    CheckConnection.ShowToast_Short(getApplicationContext(),"Hết sản phẩm được bày bán");
                }
