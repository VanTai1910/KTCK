    ...
    private void DangNhap() {
        btnDangNhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.equals("tai@gmail.com") && password.equals("tai123")) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.DuongDanTaikhoan, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if (response.equals("1")) {
                                ...
                                Toast.makeText(DangNhapActivity.this, "Thông tin tài khoản của bạn không chính xác.", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                    ...
                    Toast.makeText(DangNhapActivity.this, "Mời bạn vui lòng nhập thông tin", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
