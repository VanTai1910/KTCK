...
public class ThongTinShopActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        LatLng shopNDT = new LatLng(15.973444078635618, 108.25256969752692);
        mMap.addMarker(new MarkerOptions().position(shopNDT).title("Shop TW").icon(BitmapDescriptorFactory.defaultMarker()));
