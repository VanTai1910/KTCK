...
import com.VanTai_2050531200304.appbanhang.adapter.GioHangAdapter;
        ...
        btnThanhToan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (MainActivity.mangGioHang.size()>0){
                    ...
                    CheckConnection.ShowToast_Short(getApplicationContext(),"Vui lòng bạn thêm sản phẩm vào giỏ hàng để thanh toán");
                }
            }
        });
    }
